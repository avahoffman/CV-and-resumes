...
\newcommand{\experienceboxsize}{108mm}
% size of the divider 
\newcommand{\dividerwidth}{1mm}
% size of the righthand column: 
\newcommand{\educationboxsize}{80mm}
...
%----------------------------------------------------------------------------------------
\addtoolbox{
	\normalsize \toolboxitem{lightgray}{Python} \\ \normalsize
	scikit-learn \colordot
        ...
        %	Gensim 
        %	Jupyter Notebook 
        	\vspace{-6mm} \normalsize \toolboxitem{lightgray}{R} \\ \normalsize
	RStan \colordot
        	shiny \colordot
        	leaps \colordot
        	lavaan \colordot
...
%----------------------------------------------------------------------------------------
\addtechniques{
	\normalsize \toolboxitem{lightgray}{statistics} \\ \normalsize
	...
	repeated measures \\
        ...
        % Rstan $\cdot$ JAGS $\cdot$ SAS
        	\vspace{-6mm} \normalsize \toolboxitem{lightgray}{supervised learning} \\ \normalsize
        ...
        SEM \\
        	...
        	\vspace{-6mm} \normalsize \toolboxitem{lightgray}{unsupervised learning} \\ \normalsize
        PCA \colordot
        k-means \colordot
        feature engineering
