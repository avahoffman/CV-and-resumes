...
%        \experienceitem{Postdoctoral Fellow}{Johns Hopkins University}{Baltimore, MD}{March 2020+}{
%           \item Led the Urban Evolution Comparative Study, aimed at understanding how plants adapt to city landscapes, using genetic sequencing and quantitative analysis
%        }{jhu} \\
%        \vspace{1mm}

        \experienceitem{Data Scientist}{The Boston Consulting Group - Gamma}{Boston, MA}{March 2019 - March 2020}{
           \item Built PySpark productionalized nested logistic regression model (>85\% accuracy) for assessing risk and product recommendation insights in commercial customers of a Fortune 500 Financial Institution
           \item Designed and hosted fully customized RShiny dashboard to visualize internal initiatives reducing carbon emissions
