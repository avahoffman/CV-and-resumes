...
% Projects text
\projects{
	\textbf{ESS 575} - Implemented Bayesian models for ecological data using JAGS \vspace{2mm} \\ 
        \textbf{Stan Seminars} - Implemented Bayesian models for ecological data using RStan \vspace{-1mm} \\ 
        \textbf{NSCI 588} - Analyzed genomic data (.fastq and .fasta) using Python \vspace{2mm} \\
        \textbf{Overheard at ESA} - Android app developed in MIT App Builder workshop \vspace{2mm} \\
        \textbf{STAT 511 \& 512 } - implemented principles of statistical design, inference, methods, \& toolbox skills for research \vspace{2mm} \\
        \textbf{Teaching} - 7 semesters teaching \& 4 years student mentoring experience \vspace{2mm} \\
        %\textbf{DuPont-Pioneer} - performed innovative drought research in the biotech industry for 1 year\\
        }
