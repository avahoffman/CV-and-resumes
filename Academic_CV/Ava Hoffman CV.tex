...
{ECOLOGIST $\cdot$ DATA SCIENTIST} %title 
{
% use \Letter~ .. \Mobilefone~ .. \Mundus~ for little icons
 \href{mailto:avamariehoffman@gmail.com}{avamariehoffman@gmail.com}  $\cdot$ %email
+1 804 687 7476  $\cdot$ %phone
...
2020 & \textbf{Hoffman, AM} and MD Smith. Nonlinear drought plasticity reveals intraspecific diversity in a dominant grass species. \textcolor{special}{\textit{Functional Ecology}}.\\

2020 & Knapp, AK, A Chen, RJ Griffin-Nolan, LE Baur, CJW Carroll, JE Gray, \textbf{AM Hoffman}, X Li, AK Post, IJ Slette, SL Collins, Y Luo, MD Smith. Resolving the Dust Bowl paradox of grassland responses to extreme drought. \textcolor{special}{\textit{PNAS}}.\\
...
%In prep. & \textbf{Hoffman, AM}, M Swall*, JA Bushey, TW Ocheltree, and MD Smith. BOUTELOUA GENE EXP PAPER
...
In review & \textbf{Hoffman, AM}, NP Lemoine, TW Ocheltree. Metabolomic and physiological responses to nitrogen addition in dominant semi-arid grassland species. \textit{Manuscript available upon request}.\\
...
%\section{Skills}
%\begin{tabular}{>{\raggedleft\arraybackslash}p{2cm}p{16cm}}
%\textbf{Programming} & R $\cdot$  python \\
%\end{tabular}
%\sectionspace
...
2020 & \textbf{Ecological Society of America} $\cdot$ \textit{Remote}\\
...
\begin{tabular}{>{\raggedleft\arraybackslash}p{2cm}p{16cm}}
	...
	\textcolor{special}{\textit{Agronomy}} $\cdot$
	\textcolor{special}{\textit{Plant Biology}} $\cdot$
	\textcolor{special}{\textit{Plants}}
	\\
2011 - 2020 & \textbf{Ecological Society of America} $\cdot$ Member \\
