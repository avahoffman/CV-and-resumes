...
% Force page width tables
\usepackage{tabularx} % in the preamble
% Add background graphic if desired
\usepackage{tikz}
...
\newcommand{\educationboxsize}{8in}
...
\newcommand{\educationitem}[6]{
	\begin{tabular}{c}
		{\includegraphics[width=\logosize, height=\logosize]{#6}} \hspace{\logopad}
	\end{tabular}
        & 
         \begin{tabular}{ll}
                \small\textbf{#1 $\cdot$ #2 $\cdot$ #3} \vspace{-0.1cm} \\
...
\newcommand{\achievementitem}[4]{
	\begin{tabular}{c}
		{\includegraphics[width=\logosize, height=\logosize]{#4}} \hspace{\logopad}
	\end{tabular}
        & 
         \begin{tabular}{ll}
...
%\tikz[remember picture,overlay] \node[opacity=1, anchor=north east,inner sep=0pt] at (current page.north east)
%             {\includegraphics[width=\paperwidth,height=1.2in]{graphic.jpg}};
...
{\begin{tabularx}{\educationboxsize}{X} \vspace{-0.2cm}

    \Large\underline{EDUCATION} \vspace{0.2cm}\\
...
{\begin{tabularx}{\educationboxsize}{X} \vspace{-0.2cm}
    ...
    \Large\underline{ACHIEVEMENTS} \vspace{0.2cm}\\
    
    {\begin{tabularx}{\educationboxsize}{lX}
    
	\achievementitem{Sustainability Leadership Fellow}{Colorado State University}{2017-2018}{csu}
...
\begin{tabularx}{\toolboxsize}{X} \vspace{0.5cm}
    ...
    \Large\underline{TOOLS} \vspace{0.2cm}\\
